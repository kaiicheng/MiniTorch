...
class Module:
    ...
    def train(self) -> None:
        ...
        # Set the mode of this module to `train`
        self.training = True
        #  set all descendent modules to `train`
    ...
    def named_parameters(self) -> Sequence[Tuple[str, Parameter]]:
        ...
        """
        # TODO: Implement for Task 0.4.
        # turn self._parameters into list
        ...
        ## alternative:
        # for str, module in self._modules.items():
        #    ans += [ (str + "." + name, para) for name, para in module.name_parameters()]
        return ans
        # raise NotImplementedError("Need to implement for Task 0.4")
    ...
    def parameters(self) -> Sequence[Parameter]:
        ...
        """
        # TODO: Implement for Task 0.4.
        # store valus of self._parameters
        ans = list(self._parameters.values())
        # and then store parameters of self.modules.
        for module in self.modules():
