...
def test_sigmoid(a: float) -> None:
    ...
    * It is  strictly increasing.
    ...
    assert_close(sigmoid(a) + sigmoid(-a), 1.0)  # property of sigmoid function, check graph
    assert_close(sigmoid(0), 0.5)   # property of sigmoid function, check graph
...
def test_distribute(a: float, b: float, c: float) -> None:
    ...
    """
    # TODO: Implement for Task 0.2.
    assert_close(mul(a + b, c), mul(a, c) + mul(b, c))
...
def test_sum_distribute(ls1: List[float], ls2: List[float]) -> None:
    ...
    sum_ls1_ls2 = ls1 + ls2
    assert_close(sum(ls1) + sum(ls2), sum(sum_ls1_ls2))
